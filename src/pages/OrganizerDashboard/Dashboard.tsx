...
const Dashboard: React.FC = () => {
	...
	useEffect(() => {
		document.title = "Dashboard | TreasureKoii";
			...
			{userAnOrganizer && (
				<div>
					...
					<div className="flex flex-col justify-center items-center">
						...
						<div className="m-10">
							<p className="text-2">Add an announcement!(designed for 'during the hunt' phase)</p>
						...
						{/* Add rule div */}
						<div className="m-10">
							<p className="text-2">Add a rule!(designed for 'before the hunt' phase)</p>
